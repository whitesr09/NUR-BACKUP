...
const CACHE='nur-shell-level4-1';
...
const CORE=[
 ...
 './nur-level3.css','./nur-vault.css','./nur-level4.css',
 ...
 './nur-progress.js','./nur-pro.js','./manifest.webmanifest','./icon.svg',
 './assets/loading-bg.jpg','./assets/daily-light-bg.jpg'
];
...
self.addEventListener('fetch',event=>{
 ...
 // Do not cache arbitrary same-origin URLs, private exports, API responses or user files.
